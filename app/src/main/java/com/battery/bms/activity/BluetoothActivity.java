...
import com.battery.bms.SSP.BluetoothClientService;
import com.battery.bms.SSP.ClsUtils;
import com.battery.bms.SSP.Device;
import com.battery.bms.SSP.DeviceAdapter;
...
public class BluetoothActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private BroadcastReceiver mBluetoothReceiver = new BroadcastReceiver(){
        ...
        public void onReceive(Context context, final Intent intent) {
            ...
            if(BluetoothTools.ACTION_RECEIVE_DATA.equals(action)){
                ...
                Log.i(TAG,"Activity收到数据："+recData);
                contentView.setText(stringBuffer);
                stringBuffer.delete(0,stringBuffer.length());
                Intent intent2 = new Intent();
                intent2.putExtra("data", recData);
                intent2.setClass(BluetoothActivity.this, CurrentStateActivity.class);
            ...
            if(BluetoothTools.ACTION_CONNECT_SUC.equals(action)){
                Toast.makeText(context,"SPP连接成功",Toast.LENGTH_LONG).show();
            }
        }
    };
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initBluetooth();
        adapter = new DeviceAdapter(BluetoothActivity.this,R.layout.device_item,deviList);
    ...
    protected void onStart() {
        //启动服务
        Intent startServ = new Intent(BluetoothActivity.this, BluetoothClientService.class);
        ...
        switch (v.getId()){
            case R.id.search_bt: {
                ...
                if ("".equals(editView.getText().toString().trim())) {
                    Toast.makeText(BluetoothActivity.this, "输入不能为空",
